...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-phone-login-phone-login-module~phone-login-phone-login-module"], {
  /***/
  ...
  /***/
  function node_modulesDialogPolyfillDialogPolyfillJs(module, exports, __webpack_require__) {
    ...
    (function () {
      ...
      if (true && 'amd' in __webpack_require__(
      /*! !webpack amd define */
  ...
  /*! exports provided: FirebaseUIModule, FirebaseUISignInFailure, FirebaseUISignInSuccessWithAuthResult, FirebaseuiAngularLibraryComponent, FirebaseuiAngularLibraryService, firebase, firebaseui */

  /***/
  function node_modulesFirebaseuiAngularFesm2015FirebaseuiAngularJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FirebaseUIModule", function () {
      return FirebaseUIModule;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "FirebaseUISignInFailure", function () {
      return FirebaseUISignInFailure;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "FirebaseUISignInSuccessWithAuthResult", function () {
      return FirebaseUISignInSuccessWithAuthResult;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "FirebaseuiAngularLibraryComponent", function () {
      return FirebaseuiAngularLibraryComponent;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "FirebaseuiAngularLibraryService", function () {
    ...
    __webpack_require__.d(__webpack_exports__, "firebaseui", function () {
      return firebaseui;
    });
    /* harmony import */
    ...
    var FirebaseuiAngularLibraryService = function FirebaseuiAngularLibraryService(options, nameOrConfig, zone) {
      _classCallCheck(this, FirebaseuiAngularLibraryService);

      // noinspection JSNonASCIINames
      var app = Object(_angular_fire__WEBPACK_IMPORTED_MODULE_2__["ɵfirebaseAppFactory"])(options, zone, nameOrConfig); // store the firebaseui instance on the window object to prevent double initialization

      if (!window.firebaseUiInstance) {
        window.firebaseUiInstance = new firebaseui__WEBPACK_IMPORTED_MODULE_1__["auth"].AuthUI(app.auth());
      }
    ...
    FirebaseuiAngularLibraryService.ctorParameters = function () {
      return [{
        ...
        decorators: [{
          ...
          args: [_angular_fire__WEBPACK_IMPORTED_MODULE_2__["FIREBASE_OPTIONS"]]
        }]
      }, {
        type: undefined,
        decorators: [{
          ...
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Inject"],
          args: [_angular_fire__WEBPACK_IMPORTED_MODULE_2__["FIREBASE_APP_NAME"]]
        }]
      }, {
    ...
    var FirebaseuiAngularLibraryComponent = /*#__PURE__*/function () {
      function FirebaseuiAngularLibraryComponent(angularFireAuth, _firebaseUiConfig, _firebaseUiConfig_Feature, ngZone, firebaseUIService) {
        _classCallCheck(this, FirebaseuiAngularLibraryComponent);
        ...
        this.signInSuccessWithAuthResultCallback = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"](); // tslint:disable-line

        this.signInFailureCallback = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"](); // tslint:disable-line

        this.uiShownCallback = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"](); // tslint:disable-line
      }

      _createClass(FirebaseuiAngularLibraryComponent, [{
        key: "ngOnInit",
        ...
        key: "getUIAuthConfig",
        value: function getUIAuthConfig() {
        ...
        key: "firebaseUIPopup",
        value: function firebaseUIPopup() {
          var firebaseUiInstance = this.firebaseUIService.firebaseUiInstance;
          var uiAuthConfig = this.getUIAuthConfig(); // Check if callbacks got computed to reset them again after providing the to firebaseui.
        ...
        value: function getCallbacks() {
          ...
          var signInSuccessWithAuthResultCallback = function signInSuccessWithAuthResultCallback(authResult, redirectUrl) {
            _this2.ngZone.run(function () {
              _this2.signInSuccessWithAuthResultCallback.emit({
                authResult: authResult,
                redirectUrl: redirectUrl
              });
            });

            return _this2.firebaseUiConfig.signInSuccessUrl;
          };

          var signInFailureCallback = function signInFailureCallback(error) {
            _this2.ngZone.run(function () {
              _this2.signInFailureCallback.emit({
                code: error.code,
          ...
          var uiShownCallback = function uiShownCallback() {
            _this2.ngZone.run(function () {
              _this2.uiShownCallback.emit();
            });
          };
    ...
    var firebase = firebase_app__WEBPACK_IMPORTED_MODULE_5__["default"];
    var firebaseui = firebaseui__WEBPACK_IMPORTED_MODULE_1__;

    var FirebaseUISignInSuccessWithAuthResult = function FirebaseUISignInSuccessWithAuthResult() {
      _classCallCheck(this, FirebaseUISignInSuccessWithAuthResult);
    };

    var FirebaseUISignInFailure = function FirebaseUISignInFailure() {
      _classCallCheck(this, FirebaseUISignInFailure);
    };

    var FirebaseUIModule = /*#__PURE__*/function () {
      function FirebaseUIModule() {
        _classCallCheck(this, FirebaseUIModule);
      }

      _createClass(FirebaseUIModule, null, [{
        key: "forRoot",
        value: function forRoot(firebaseUiAuthConfig) {
          return {
            ...
            providers: [{
              ...
              provide: 'firebaseUIAuthConfigFeature',
              useValue: {}
            }]
          };
        }
        ...
        key: "forFeature",
        value: function forFeature(firebaseUIAuthConfig) {
          return {
            ngModule: FirebaseUIModule,
            providers: [{
              provide: 'firebaseUIAuthConfigFeature',
  ...
  /***/
  function node_modulesFirebaseuiDistEsmJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var dialog_polyfill__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! dialog-polyfill */
    "./node_modules/dialog-polyfill/dialog-polyfill.js");
    /* harmony import */


    var dialog_polyfill__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(dialog_polyfill__WEBPACK_IMPORTED_MODULE_2__);
    /* harmony import */


    var material_design_lite_src_mdlComponentHandler__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! material-design-lite/src/mdlComponentHandler */
    "./node_modules/material-design-lite/src/mdlComponentHandler.js");
    /* harmony import */


    var material_design_lite_src_mdlComponentHandler__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(material_design_lite_src_mdlComponentHandler__WEBPACK_IMPORTED_MODULE_3__);
    /* harmony import */


    var material_design_lite_src_button_button__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! material-design-lite/src/button/button */
    "./node_modules/material-design-lite/src/button/button.js");
    /* harmony import */


    var material_design_lite_src_button_button__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(material_design_lite_src_button_button__WEBPACK_IMPORTED_MODULE_4__);
    /* harmony import */


    var material_design_lite_src_progress_progress__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! material-design-lite/src/progress/progress */
    "./node_modules/material-design-lite/src/progress/progress.js");
    /* harmony import */


    var material_design_lite_src_progress_progress__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(material_design_lite_src_progress_progress__WEBPACK_IMPORTED_MODULE_5__);
    /* harmony import */


    var material_design_lite_src_spinner_spinner__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! material-design-lite/src/spinner/spinner */
    "./node_modules/material-design-lite/src/spinner/spinner.js");
    /* harmony import */


    var material_design_lite_src_spinner_spinner__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(material_design_lite_src_spinner_spinner__WEBPACK_IMPORTED_MODULE_6__);
    /* harmony import */


    var material_design_lite_src_textfield_textfield__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! material-design-lite/src/textfield/textfield */
    "./node_modules/material-design-lite/src/textfield/textfield.js");
    /* harmony import */


    var material_design_lite_src_textfield_textfield__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(material_design_lite_src_textfield_textfield__WEBPACK_IMPORTED_MODULE_7__);
    ...
    (function () {
      (function () {
        ...
        function t(a, b, c) {
          Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? t = wa : t = ya;
        ...
        function Ca(a) {
          if (Error.captureStackTrace) Error.captureStackTrace(this, Ca);else {
            var b = Error().stack;
            b && (this.stack = b);
          }
        ...
        function db(a) {
          bb.test(a) && (-1 != a.indexOf("&") && (a = a.replace(Wa, "&amp;")), -1 != a.indexOf("<") && (a = a.replace(Xa, "&lt;")), -1 != a.indexOf(">") && (a = a.replace(Ya, "&gt;")), -1 != a.indexOf('"') && (a = a.replace(Za, "&quot;")), -1 != a.indexOf("'") && (a = a.replace($a, "&#39;")), -1 != a.indexOf("\x00") && (a = a.replace(ab, "&#0;")));
          return a;
        }
        ...
        var ib = "StopIteration" in p ? p.StopIteration : {
        ...
        function nb(a, b) {
          ...
          } else if (a) if (a instanceof nb) for (c = a.ja(), d = 0; d < c.length; d++) {
        ...
        l.la = function (a) {
          Mb(this);
          var b = [];
          if (q(a)) Pb(this, a) && (b = Ra(b, this.a.get(Nb(this, a))));else {
            a = this.a.la();
        ...
        var Wd = !z || 9 <= Number(oc),
          ...
          try {
            p.addEventListener("test", na, b), p.removeEventListener("test", na, b);
          } catch (c) {}
        ...
        fe.prototype.add = function (a, b, c, d, e) {
          ...
          a || (a = this.a[f] = [], this.g++);
          var g = ge(a, b, d, e);
          -1 < g ? (b = a[g], c || (b.Ia = !1)) : (b = new de(b, this.src, f, !!d, e), b.Ia = c, a.push(b));
          return b;
        };
        ...
        function te(a, b, c, d, e) {
          if (qa(b)) for (var f = 0; f < b.length; f++) {
            te(a, b[f], c, d, e);
          } else (d = ta(d) ? !!d.capture : !!d, c = ne(c), a && a[be]) ? (a = a.J, b = String(b).toString(), b in a.a && (f = a.a[b], c = ge(f, c, d, e), -1 < c && (ee(f[c]), Oa(f, c), 0 == f.length && (delete a.a[b], a.g--)))) : a && (a = pe(a)) && (b = a.a[b.toString()], a = -1, b && (a = ge(b, c, d, e)), (c = -1 < a ? b[a] : null) && ue(c));
        }
        ...
        function Ce(a, b) {
          ...
          a = De(a);
          if (Ae[a] && Ae[a].length) for (var c = 0; c < Ae[a].length; c++) {
            ye(Ae[a][c], b);
          }
        }
        ...
        function Te() {
          if (p.Promise && p.Promise.resolve) {
            ...
            var b = Ve;
            !sa(p.setImmediate) || p.Window && p.Window.prototype && !y("Edge") && p.Window.prototype.setImmediate == p.setImmediate ? (Pe || (Pe = Qe()), Pe(b)) : p.setImmediate(b);
          };
        }
        ...
        function If(a) {
          ...
          0 < k && (h = window.setTimeout(function () {
            Jf(e, !0);
            var n = new Kf(Lf, "Timeout reached for loading script " + d);
            Af(g);
            Bf(g, !1, n);
          }, k), f.sb = h);

          e.onload = e.onreadystatechange = function () {
            e.readyState && "loaded" != e.readyState && "complete" != e.readyState || (Jf(e, b.vc || !1, h), g.callback(null));
          };
        ...
        function Of() {
          return p.google && p.google.accounts && p.google.accounts.id || null;
        }
        ...
        Rf.prototype.load = function () {
          ...
          var b = wc();
          return Of() ? G() : this.a = uf().then(function () {
        ...
        Sf.prototype.confirm = function (a) {
          return G(this.a.confirm(a)).Ca(this.g);
        };
        ...
        function Cg(a) {
          if (a && a.email) {
            var b = a.credential && firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.AuthCredential.fromJSON(a.credential);
        ...
        function Xh(a) {
          a = Va(a);
          var b = Ph(Vh, a);
          return 0 < b.length ? new Wh("1" == b[0].b ? "1-US-0" : b[0].c, Va(a.substr(b[0].b.length + 1))) : null;
        }
        ...
        function ji(a) {
          return Ka(fi(a), function (b) {
            ...
            return {
              ...
              ta: b.buttonColor || null,
              za: b.iconUrl ? Ac(Cc(b.iconUrl)).toString() : null,
              Mb: b.loginHintKey || null
            };
          });
        }

        function li(a) {
          var b = gi(a, firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.GoogleAuthProvider.PROVIDER_ID);
        ...
        function oi(a) {
          var b = null;
          Ha(fi(a), function (d) {
            d.provider == firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.PhoneAuthProvider.PROVIDER_ID && ta(d.recaptchaParameters) && !Array.isArray(d.recaptchaParameters) && (b = fb(d.recaptchaParameters));
          });
        ...
        function ri(a, b) {
          ...
          return ta(a) ? (a = fb(a), b === firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.GoogleAuthProvider.PROVIDER_ID && delete a.login_hint, b === firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.GithubAuthProvider.PROVIDER_ID && delete a.login, a) : null;
        }

        function si(a) {
          a = gi(a, firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.PhoneAuthProvider.PROVIDER_ID);
          var b = null;
        ...
        function ti(a) {
          var b = (a = gi(a, firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.PhoneAuthProvider.PROVIDER_ID)) && a.defaultCountry || null;
          b = b && Sh(b);
          var c = null;
        ...
        function xi(a) {
          return (a = gi(a, firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.EmailAuthProvider.PROVIDER_ID)) && "undefined" !== typeof a.requireDisplayName ? !!a.requireDisplayName : !0;
        }

        function yi(a) {
          a = gi(a, firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.EmailAuthProvider.PROVIDER_ID);
          return !(!a || a.signInMethod !== firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.EmailAuthProvider.EMAIL_LINK_SIGN_IN_METHOD);
        }
        ...
        function Ai(a) {
          if (yi(a)) {
            ...
            (a = gi(a, firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.EmailAuthProvider.PROVIDER_ID)) && "function" === typeof a.emailLinkSignIn && hb(b, a.emailLinkSignIn());
            a = b.url;
            var c = tf();
        ...
        function Fi(a) {
          return Gi(a).signInSuccess || null;
        }

        function Hi(a) {
          return Gi(a).signInSuccessWithAuthResult || null;
        }

        function ei(a) {
          return Gi(a).signInFailure || null;
        }
        ...
        function Qi(a, b) {
          return a.classList ? a.classList.contains(b) : Ma(Pi(a), b);
        }

        function Ri(a, b) {
          a.classList ? a.classList.add(b) : Qi(a, b) || (a.className += 0 < a.className.length ? " " + b : b);
        }

        function Si(a, b) {
          a.classList ? a.classList.remove(b) : Qi(a, b) && (a.className = Ja(Pi(a), function (c) {
            return c != b;
          }).join(" "));
        }
        ...
        function Yi(a) {
          if (ec) a = Zi(a);else if (hc && fc) switch (a) {
            case 93:
              a = 91;
          }
          return a;
        ...
        hj.prototype.handleEvent = function () {
        ...
        lj.prototype.handleEvent = function (a) {
          if ("input" == a.type) z && nc(10) && 0 == a.keyCode && 0 == a.j || (mj(this), ye(this, nj(a)));else if ("keydown" != a.type || Vi(a)) {
        ...
        function oj(a, b) {
          E.call(this);
          a && (this.Oa && pj(this), this.qa = a, this.Na = le(this.qa, "keypress", this, b), this.Ya = le(this.qa, "keydown", this.Hb, b, this), this.Oa = le(this.qa, "keyup", this.Ib, b, this));
        }
        ...
        l.Hb = function (a) {
          if (fc || cc) if (17 == this.R && !a.ctrlKey || 18 == this.R && !a.altKey || hc && 91 == this.R && !a.metaKey) this.X = this.R = -1;
        ...
        l.handleEvent = function (a) {
          ...
          } else (fc || cc) && "keypress" == a.type ? (d = this.X, e = 0 <= b.charCode && 63232 > b.charCode && Wi(d) ? b.charCode : 0) : bc && !fc ? (d = this.X, e = Wi(d) ? b.keyCode : 0) : ("keypress" == a.type ? (tj && (c = this.Ua), b.keyCode == b.charCode ? 32 > b.keyCode ? (d = b.keyCode, e = 0) : (d = this.X, e = b.charCode) : (d = b.keyCode || this.X, e = b.charCode || 0)) : (d = b.keyCode || this.X, e = b.charCode || 0), hc && 63 == e && 224 == d && (d = 191));
        ...
        function Aj(a, b) {
          ...
          if (c in Bj) a = Bj[c];else if (/^\d+px?$/.test(c)) a = parseInt(c, 10);else {
            b = a.style.left;
        ...
        function Mj(a) {
          return !Qi(a, "firebaseui-hidden") && "none" != a.style.display;
        }
        ...
        function Nj(a) {
          ...
          d = a.uc ? d + "Enter new email address" : d + "Email";
        ...
        function bk(a) {
          ...
          b = "" + Zj({
            zb: D("firebaseui-list-box-dialog"),
            content: ud(b + "</div>")
          });
          return B(b);
        }
        ...
        function fk(a, b) {
          a && window.componentHandler && window.componentHandler[b] && Ha(hk, function (c) {
            if (Qi(a, c)) window.componentHandler[b](a);
        ...
        l.v = function () {
          P.K.v.call(this);
          Ce(Q(this), new pk("pageEnter", Q(this), {
            pageId: this.Ga
          }));
        ...
        l.ya = function () {
          Ce(Q(this), new pk("pageExit", Q(this), {
            pageId: this.Ga
          }));
          P.K.ya.call(this);
        };
        ...
        function qk(a) {
          ...
          a.ca = window.setTimeout(function () {
            a.N() && null === a.A && (a.A = id(ck, {
              tb: b
            }, null, a.s), a.N().appendChild(a.A), ek(a.A));
          }, 500);
        }
        ...
        function tk(a, b, c) {
          ...
          b = a.Va;
          var d = a.ia;
          a = '<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-sign-in"><form onsubmit="return false;"><div class="firebaseui-card-header"><h1 class="firebaseui-title">Sign in with email</h1></div><div class="firebaseui-card-content"><div class="firebaseui-relative-wrapper">' + Nj(a) + '</div></div><div class="firebaseui-card-actions"><div class="firebaseui-form-actions">' + (b ? Vj(null) : "") + Oj(null) + '</div></div><div class="firebaseui-card-footer">' + (d ? Xj(c) : Wj(c)) + "</div></form></div>";
          return B(a);
        }
        ...
        function uk(a, b, c) {
          a = a || {};
          b = a.ia;
          a = '<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-password-sign-in"><form onsubmit="return false;"><div class="firebaseui-card-header"><h1 class="firebaseui-title">Sign in</h1></div><div class="firebaseui-card-content">' + Nj(a) + Tj() + '</div><div class="firebaseui-card-actions"><div class="firebaseui-form-links">' + Uj() + '</div><div class="firebaseui-form-actions">' + Pj() + '</div></div><div class="firebaseui-card-footer">' + (b ? Xj(c) : Wj(c)) + "</div></form></div>";
          return B(a);
        }
        ...
        function vk(a, b, c) {
          ...
          b = a.Ta;
          var e = a.ia,
              f = '<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-password-sign-up"><form onsubmit="return false;"><div class="firebaseui-card-header"><h1 class="firebaseui-title">Create account</h1></div><div class="firebaseui-card-content">' + Nj(a);
        ...
        function wk(a, b, c) {
          a = a || {};
          b = a.Ta;
          a = '<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-password-recovery"><form onsubmit="return false;"><div class="firebaseui-card-header"><h1 class="firebaseui-title">Recover password</h1></div><div class="firebaseui-card-content"><p class="firebaseui-text">Get instructions sent to this email that explain how to reset your password</p>' + Nj(a) + '</div><div class="firebaseui-card-actions"><div class="firebaseui-form-actions">' + (b ? Vj(null) : "") + Oj({
            label: D("Send")
          }) + '</div></div><div class="firebaseui-card-footer">' + Wj(c) + "</div></form></div>";
          return B(a);
        }
        ...
        function xk(a, b, c) {
          ...
          b && (d += '<div class="firebaseui-form-actions">' + Oj({
            label: D("Done")
          }) + "</div>");
        ...
        function yk(a, b, c) {
          return B('<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-callback"><div class="firebaseui-callback-indicator-container">' + ck(null, null, c) + "</div></div>");
        }

        yk.a = "firebaseui.auth.soy2.page.callback";

        function zk(a, b, c) {
          return B('<div class="firebaseui-container firebaseui-id-page-spinner">' + ck({
            tb: !0
          }, null, c) + "</div>");
        }
        ...
        function Bk(a, b, c) {
          ...
          b += '<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-email-link-sign-in-sent"><form onsubmit="return false;"><div class="firebaseui-card-header"><h1 class="firebaseui-title">Sign-in email sent</h1></div><div class="firebaseui-card-content"><div class="firebaseui-email-sent"></div><p class="firebaseui-text">' + a + '</p></div><div class="firebaseui-card-actions"><div class="firebaseui-form-links">' + d + '</div><div class="firebaseui-form-actions">' + Vj({
            label: D("Back")
          }) + '</div></div><div class="firebaseui-card-footer">' + Wj(c) + "</div></form></div>";
          return B(b);
        }
        ...
        function Dk(a, b, c) {
          a = '<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-email-link-sign-in-confirmation"><form onsubmit="return false;"><div class="firebaseui-card-header"><h1 class="firebaseui-title">Confirm email</h1></div><div class="firebaseui-card-content"><p class="firebaseui-text">Confirm your email to complete sign in</p><div class="firebaseui-relative-wrapper">' + Nj(a) + '</div></div><div class="firebaseui-card-actions"><div class="firebaseui-form-actions">' + Vj(null) + Oj(null) + '</div></div><div class="firebaseui-card-footer">' + Wj(c) + "</div></form></div>";
          return B(a);
        }
        ...
        function Ek() {
          var a = '<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-different-device-error"><div class="firebaseui-card-header"><h1 class="firebaseui-title">New device or browser detected</h1></div><div class="firebaseui-card-content"><p class="firebaseui-text">Try opening the link using the same device or browser where you started the sign-in process.</p></div><div class="firebaseui-card-actions"><div class="firebaseui-form-actions">' + Vj({
            label: D("Dismiss")
          }) + "</div></div></div>";
          return B(a);
        }
        ...
        function Fk() {
          var a = '<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-anonymous-user-mismatch"><div class="firebaseui-card-header"><h1 class="firebaseui-title">Session ended</h1></div><div class="firebaseui-card-content"><p class="firebaseui-text">The session associated with this sign-in request has either expired or was cleared.</p></div><div class="firebaseui-card-actions"><div class="firebaseui-form-actions">' + Vj({
            label: D("Dismiss")
          }) + "</div></div></div>";
          return B(a);
        }
        ...
        function Gk(a, b, c) {
          ...
          b += '<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-password-linking"><form onsubmit="return false;"><div class="firebaseui-card-header"><h1 class="firebaseui-title">Sign in</h1></div><div class="firebaseui-card-content"><h2 class="firebaseui-subtitle">You already have an account</h2><p class="firebaseui-text">' + a + "</p>" + Tj() + '</div><div class="firebaseui-card-actions"><div class="firebaseui-form-links">' + Uj() + '</div><div class="firebaseui-form-actions">' + Pj() + '</div></div><div class="firebaseui-card-footer">' + Wj(c) + "</div></form></div>";
          return B(b);
        }
        ...
        function Hk(a, b, c) {
          ...
          b += '<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-email-link-sign-in-linking"><form onsubmit="return false;"><div class="firebaseui-card-header"><h1 class="firebaseui-title">Sign in</h1></div><div class="firebaseui-card-content"><h2 class="firebaseui-subtitle">You already have an account</h2><p class="firebaseui-text firebaseui-text-justify">' + d + '<p class="firebaseui-text firebaseui-text-justify">' + a + '</p></div><div class="firebaseui-card-actions"><div class="firebaseui-form-actions">' + Pj() + '</div></div><div class="firebaseui-card-footer">' + Wj(c) + "</div></form></div>";
          return B(b);
        }
        ...
        function Ik(a, b, c) {
          ...
          b += '<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-email-link-sign-in-linking-different-device"><form onsubmit="return false;"><div class="firebaseui-card-header"><h1 class="firebaseui-title">Sign in</h1></div><div class="firebaseui-card-content"><p class="firebaseui-text firebaseui-text-justify">' + a + '</p><p class="firebaseui-text firebaseui-text-justify">' + d + '</p></div><div class="firebaseui-card-actions"><div class="firebaseui-form-actions">' + Rj() + '</div></div><div class="firebaseui-card-footer">' + Wj(c) + "</div></form></div>";
          return B(b);
        }
        ...
        function Jk(a, b, c) {
          ...
          b += '<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-federated-linking"><form onsubmit="return false;"><div class="firebaseui-card-header"><h1 class="firebaseui-title">Sign in</h1></div><div class="firebaseui-card-content"><h2 class="firebaseui-subtitle">You already have an account</h2><p class="firebaseui-text">' + d + '</p></div><div class="firebaseui-card-actions"><div class="firebaseui-form-actions">' + Oj({
        ...
        function Kk(a, b, c) {
          ...
          b += '<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-unsupported-provider"><form onsubmit="return false;"><div class="firebaseui-card-header"><h1 class="firebaseui-title">Sign in</h1></div><div class="firebaseui-card-content"><p class="firebaseui-text">' + a + '</p></div><div class="firebaseui-card-actions"><div class="firebaseui-form-actions">' + Vj(null) + Oj({
        ...
        function Lk(a) {
          ...
          b += '<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-password-reset"><form onsubmit="return false;"><div class="firebaseui-card-header"><h1 class="firebaseui-title">Reset your password</h1></div><div class="firebaseui-card-content">' + c + Sj(td(a)) + '</div><div class="firebaseui-card-actions"><div class="firebaseui-form-actions">' + Qj() + "</div></div></form></div>";
          return B(b);
        }
        ...
        function Mk(a) {
          a = a || {};
          a = '<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-password-reset-success"><div class="firebaseui-card-header"><h1 class="firebaseui-title">Password changed</h1></div><div class="firebaseui-card-content"><p class="firebaseui-text">You can now sign in with your new password</p></div><div class="firebaseui-card-actions">' + (a.G ? '<div class="firebaseui-form-actions">' + Rj() + "</div>" : "") + "</div></div>";
          return B(a);
        }
        ...
        function Nk(a) {
          a = a || {};
          a = '<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-password-reset-failure"><div class="firebaseui-card-header"><h1 class="firebaseui-title">Try resetting your password again</h1></div><div class="firebaseui-card-content"><p class="firebaseui-text">Your request to reset your password has expired or the link has already been used</p></div><div class="firebaseui-card-actions">' + (a.G ? '<div class="firebaseui-form-actions">' + Rj() + "</div>" : "") + "</div></div>";
          return B(a);
        }
        ...
        function Pk(a) {
          a = a || {};
          a = "<div class=\"mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-email-change-revoke-failure\"><div class=\"firebaseui-card-header\"><h1 class=\"firebaseui-title\">Unable to update your email address</h1></div><div class=\"firebaseui-card-content\"><p class=\"firebaseui-text\">There was a problem changing your sign-in email back.</p><p class=\"firebaseui-text\">If you try again and still can\u2019t reset your email, try asking your administrator for help.</p></div><div class=\"firebaseui-card-actions\">" + (a.G ? '<div class="firebaseui-form-actions">' + Rj() + "</div>" : "") + "</div></div>";
          return B(a);
        }
        ...
        function Qk(a) {
          a = a || {};
          a = '<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-email-verification-success"><div class="firebaseui-card-header"><h1 class="firebaseui-title">Your email has been verified</h1></div><div class="firebaseui-card-content"><p class="firebaseui-text">You can now sign in with your new account</p></div><div class="firebaseui-card-actions">' + (a.G ? '<div class="firebaseui-form-actions">' + Rj() + "</div>" : "") + "</div></div>";
          return B(a);
        }
        ...
        function Sk(a) {
          ...
          c += '<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-verify-and-change-email-success"><div class="firebaseui-card-header"><h1 class="firebaseui-title">Your email has been verified and changed</h1></div><div class="firebaseui-card-content"><p class="firebaseui-text">' + a + '</p></div><div class="firebaseui-card-actions">' + (b ? '<div class="firebaseui-form-actions">' + Rj() + "</div>" : "") + "</div></div>";
          return B(c);
        }
        ...
        function Uk(a) {
          ...
          d += '</p><p class="firebaseui-text">If you don\'t recognize this device, someone might be trying to access your account. Consider <a class="firebaseui-link firebaseui-id-reset-password-link" href="javascript:void(0)">changing your password right away</a>.</p></div><div class="firebaseui-card-actions">' + (a ? '<div class="firebaseui-form-actions">' + Rj() + "</div>" : "") + "</div></form></div>";
          return B(d);
        }
        ...
        function Vk(a) {
          a = a || {};
          a = '<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-revert-second-factor-addition-failure"><div class="firebaseui-card-header"><h1 class="firebaseui-title">Couldn\'t remove your second factor</h1></div><div class="firebaseui-card-content"><p class="firebaseui-text">Something went wrong removing your second factor.</p><p class="firebaseui-text">Try removing it again. If that doesn\'t work, contact support for assistance.</p></div><div class="firebaseui-card-actions">' + (a.G ? '<div class="firebaseui-form-actions">' + Rj() + "</div>" : "") + "</div></div>";
          return B(a);
        }
        ...
        function Zk(a, b, c) {
          ...
          b += '<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-email-mismatch"><form onsubmit="return false;"><div class="firebaseui-card-header"><h1 class="firebaseui-title">Sign in</h1></div><div class="firebaseui-card-content"><h2 class="firebaseui-subtitle">' + a + '</h2><p class="firebaseui-text">' + d + '</p></div><div class="firebaseui-card-actions"><div class="firebaseui-form-actions">' + Vj(null) + Oj({
            label: D("Continue")
          }) + '</div></div><div class="firebaseui-card-footer">' + Wj(c) + "</div></form></div>";
          return B(b);
        }
        ...
        function $k(a, b, c) {
          ...
          for (var e = 0; e < b; e++) {
            ...
            k = '<button class="firebaseui-idp-button mdl-button mdl-js-button mdl-button--raised ' + vd(C(n)) + ' firebaseui-id-idp-button" data-provider-id="' + vd(h.providerId) + '" style="background-color:';
            n = (n = f) || {};
            n = n.ga;
            ...
            r = r || {};
            r = r.ga;
            n = sd(r.za ? Ad(r.za) : n.xa[r.providerId] ? Ad(n.xa[r.providerId]) : 0 == r.providerId.indexOf("saml.") ? Ad(n.xa.saml) : 0 == r.providerId.indexOf("oidc.") ? Ad(n.xa.oidc) : Ad(n.xa.password));
            k = k + vd(Ad(n)) + '"></span>';
            "password" == h.providerId ? (k += '<span class="firebaseui-idp-text firebaseui-idp-text-long">', h.V ? k += A(h.V) : h.S ? (f = "Sign in with " + A(dk(f, g)), k += f) : k += "Sign in with email", k += '</span><span class="firebaseui-idp-text firebaseui-idp-text-short">', k = h.S ? k + A(h.S) : k + "Email", k += "</span>") : "phone" == h.providerId ? (k += '<span class="firebaseui-idp-text firebaseui-idp-text-long">', h.V ? k += A(h.V) : h.S ? (f = "Sign in with " + A(dk(f, g)), k += f) : k += "Sign in with phone", k += '</span><span class="firebaseui-idp-text firebaseui-idp-text-short">', k = h.S ? k + A(h.S) : k + "Phone", k += "</span>") : "anonymous" == h.providerId ? (k += '<span class="firebaseui-idp-text firebaseui-idp-text-long">', h.V ? k += A(h.V) : h.S ? (f = "Sign in with " + A(dk(f, g)), k += f) : k += "Continue as guest", k += '</span><span class="firebaseui-idp-text firebaseui-idp-text-short">', k = h.S ? k + A(h.S) : k + "Guest", k += "</span>") : (k += '<span class="firebaseui-idp-text firebaseui-idp-text-long">', h.V ? k += A(h.V) : (n = "Sign in with " + A(dk(f, g)), k += n), k += '</span><span class="firebaseui-idp-text firebaseui-idp-text-short">' + (h.S ? A(h.S) : A(dk(f, g))) + "</span>");
            h = B(k + "</button>");
        ...
        function bl(a, b, c) {
          ...
          c = '<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-phone-sign-in-finish"><form onsubmit="return false;"><div class="firebaseui-card-header"><h1 class="firebaseui-title">Verify your phone number</h1></div><div class="firebaseui-card-content"><p class="firebaseui-text">' + a + "</p>" + d + '</div><div class="firebaseui-card-actions"><div class="firebaseui-form-actions">' + Vj(null) + Oj({
            label: D("Continue")
          }) + '</div></div><div class="firebaseui-card-footer">' + Wj(c) + "</div></form>";
        ...
        function el(a, b, c) {
          a = '<div class="mdl-card mdl-shadow--2dp firebaseui-container firebaseui-id-page-provider-match-by-email"><form onsubmit="return false;"><div class="firebaseui-card-header"><h1 class="firebaseui-title">Sign in</h1></div><div class="firebaseui-card-content"><div class="firebaseui-relative-wrapper">' + Nj(null) + '</div></div><div class="firebaseui-card-actions"><div class="firebaseui-form-actions">' + Oj(null) + '</div></div><div class="firebaseui-card-footer">' + Xj(c) + "</div></form></div>";
          return B(a);
        }
        ...
        function hl(a, b) {
          O(this, fl.call(this), function (d) {
            a(d);
          });
          var c = gl.call(this);
        ...
        ml.prototype.j = function () {
          return Ti(M(this, "firebaseui-id-email"));
        };
        ...
        function ql(a) {
          ...
          a && Hj(this, b, function () {
            a();
          });
        }

        function rl() {
          return Va(Ti(ol.call(this)) || "");
        }
        ...
        function Al(a) {
          R.call(this, cl, void 0, void 0, a, "signOut");
        }
        ...
        function Gl(a) {
          return "auth/invalid-credential" === a.code && a.message && -1 !== a.message.indexOf("error=consent_required") ? {
        ...
        function Hl(a, b, c, d) {
          function e(g) {
            if (!g.name || "cancel" != g.name) {
              ...
              if (n) g = Q(b), b.o(), S(a, g, void 0, C("Your sign-in session has expired. Please try again.").toString());else {
                n = g && g.message || "";
          ...
          try {
            ...
            return og(g.code || g.message, g), b.a(g.code || g.message), G();
          }
        ...
        function Jl(a, b) {
          ...
          if (c) {
            ...
            if (qf()) {
              if (!d || d(c, b, e)) f = !0, Oc(window.opener.location, Ll(a, e));
              d || window.close();
        ...
        function T(a) {
          ...
          try {
            return JSON.parse(a.message), og("Internal error: " + a.message, void 0), Kd().toString();
          } catch (d) {
            return a.message;
          }
        }
        ...
        function Ml(a, b, c) {
          var d = ai[b] && firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth[ai[b]] ? new firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth[ai[b]]() : 0 == b.indexOf("saml.") ? new firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.SAMLAuthProvider(b) : new firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.OAuthProvider(b);
          ...
          e = ri(W(a), b) || {};
          c && (b == firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.GoogleAuthProvider.PROVIDER_ID ? a = "login_hint" : b == firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.GithubAuthProvider.PROVIDER_ID ? a = "login" : a = (a = ii(W(a), b)) && a.Mb, a && (e[a] = c));
        ...
        function Rl(a, b, c) {
          ...
          if (c && c.credential && c.clientId === li(W(a))) {
            if (qi(W(a), firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.GoogleAuthProvider.PROVIDER_ID).length) {
              try {
                var e = JSON.parse(atob(c.credential.split(".")[1])).email;
              } catch (f) {}

              Nl(a, b, firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.GoogleAuthProvider.PROVIDER_ID, e);
              return G(!0);
            }

            return d(firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.GoogleAuthProvider.credential(c.credential));
          }
        ...
        function Sl(a, b) {
          ...
          if (c) {
            if (d) {
              var e = firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.EmailAuthProvider.credential(c, d);
              V(a, b.I(t(a.$b, a), [c, d], function (f) {
                return Hl(a, b, {
                  user: f.user,
                  credential: e,
        ...
        function Tl(a) {
          a = hi(W(a));
          return 1 == a.length && a[0] == firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.EmailAuthProvider.PROVIDER_ID;
        }

        function Ul(a) {
          a = hi(W(a));
          return 1 == a.length && a[0] == firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.PhoneAuthProvider.PROVIDER_ID;
        }

        function S(a, b, c, d) {
          Tl(a) ? d ? L("signIn", a, b, c, d) : Vl(a, b, c) : a && Ul(a) && !d ? L("phoneSignInStart", a, b) : a && Bi(W(a)) && !d ? L("federatedRedirect", a, b, c) : L("providerSignIn", a, b, d, c);
        }
        ...
        function Xl(a, b, c, d, e, f) {
          c.length || yi(W(a)) ? !c.length && yi(W(a)) ? L("sendEmailLinkForSignIn", a, b, d, function () {
            L("signIn", a, b);
          }) : Ma(c, firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.EmailAuthProvider.EMAIL_PASSWORD_SIGN_IN_METHOD) ? L("passwordSignIn", a, b, d, f) : 1 == c.length && c[0] === firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.EmailAuthProvider.EMAIL_LINK_SIGN_IN_METHOD ? yi(W(a)) ? L("sendEmailLinkForSignIn", a, b, d, function () {
            L("signIn", a, b);
          }) : L("unsupportedProvider", a, b, d) : (c = Zh(c, hi(W(a)))) ? (Bh(new Ag(d), X(a)), L("federatedSignIn", a, b, d, c, e)) : L("unsupportedProvider", a, b, d) : L("passwordSignUp", a, b, d, void 0, void 0, f);
        }
        ...
        function Zl() {
          return ub(tf(), "oobCode");
        }

        function $l() {
          var a = ub(tf(), "continueUrl");
          return a ? function () {
        ...
        function am(a, b) {
          P.call(this, Fk, void 0, b, "anonymousUserMismatch");
          this.i = a;
        }
        ...
        function bm(a) {
          P.call(this, yk, void 0, a, "callback");
        }

        m(bm, P);

        bm.prototype.I = function (a, b, c, d) {
          ...
          if (c.user) {
            var d = {
              ...
              additionalUserInfo: c.additionalUserInfo
                ...
                e = zh(X(a)),
                f = e && e.g;
            if (f && !dm(c.user, f)) em(a, b, d);else {
              var g = e && e.a;
        ...
        function hm(a, b, c, d) {
          ...
          V(a, U(a).fetchSignInMethodsForEmail(c).then(function (f) {
            b.o();
            f.length ? Ma(f, firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.EmailAuthProvider.EMAIL_PASSWORD_SIGN_IN_METHOD) ? L("passwordLinking", a, e, c) : 1 == f.length && f[0] === firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.EmailAuthProvider.EMAIL_LINK_SIGN_IN_METHOD ? L("emailLinkSignInLinking", a, e, c) : (f = Zh(f, hi(W(a)))) ? L("federatedLinking", a, e, c, f, d) : (Ah(X(a)), L("unsupportedProvider", a, e, c)) : (Ah(X(a)), L("passwordRecovery", a, e, c, !1, Ld().toString()));
          }, function (f) {
            gm(a, b, f);
          }));
        }
        ...
        K.callback = function (a, b, c) {
          ...
          V(a, b.then(function (e) {
            ...
            if ((e = Gl(e)) && ("auth/account-exists-with-different-credential" == e.code || "auth/email-already-in-use" == e.code) && e.email && e.credential) Bh(new Ag(e.email, e.credential), X(a)), hm(a, d, e.email);else if (e && "auth/user-cancelled" == e.code) {
              var f = zh(X(a)),
                  g = T(e);
              f && f.a ? hm(a, d, f.g, g) : f ? Wl(a, d, f.g, g) : gm(a, d, e);
            } else e && "auth/credential-already-in-use" == e.code || (e && "auth/operation-not-supported-in-this-environment" == e.code && Tl(a) ? cm(a, d, {
              user: null,
              credential: null
            }) : gm(a, d, e));
          }));
        ...
        function um(a, b, c, d) {
          "auth/weak-password" == (d && d.code) ? (a = T(d), N(c.i(), !1), Lj(c.w(), a), c.i().focus()) : (c && c.o(), c = new Cl(), c.render(b), Y(a, c));
        }
        ...
        function Bm(a, b, c, d, e) {
          ...
          V(a, f.I(function () {
            ...
            xa = r && Ba || Ba && n ? df(Error("anonymous-user-not-found")) : Dm(a, c).then(function (ug) {
              if (H && !jd) throw Error("pending-credential-not-found");
              return ug;
            });
            var kd = null;
            return xa.then(function (ug) {
              kd = ug;
            ...
            Wk ? Em(a, f, Wk, c, jd, xa) : n ? (f.o(), L("differentDeviceError", a, b)) : (f.o(), L("emailLinkConfirmation", a, b, c, Fm));
          }, function (xa) {
            var kd = void 0;
        ...
        function Em(a, b, c, d, e, f) {
          ...
          e = (f ? Hm(a, f, c, d, e) : Im(a, c, d, e)).then(function (k) {
            ...
            if (!k.name || "cancel" != k.name) {
              var n = T(k);
              "auth/email-already-in-use" == k.code || "auth/credential-already-in-use" == k.code ? (wh(uh, X(a)), wh(th, X(a))) : "auth/invalid-email" == k.code ? (n = C("The email provided does not match the current sign-in session.").toString(), L("emailLinkConfirmation", a, g, d, Fm, null, n)) : S(a, g, c, n);
            }
          });
          V(a, e);
        }
        ...
        function Nm(a, b, c, d, e) {
          P.call(this, Ck, void 0, e, "emailNotReceived", {
            F: c,
            D: d
          });
          this.l = a;
        ...
        K.federatedLinking = function (a, b, c, d, e) {
          ...
          if (f && f.a) {
            var g = new Om(c, ii(W(a), d), function () {
              Nl(a, g, d, c);
            }, J(W(a)), wi(W(a)));
            g.render(b);
            Y(a, g);
        ...
        K.federatedSignIn = function (a, b, c, d, e) {
          var f = new Om(c, ii(W(a), d), function () {
            Nl(a, f, d, c);
          }, J(W(a)), wi(W(a)));
          f.render(b);
          Y(a, f);
        ...
        function Vm(a, b) {
          ...
          if (d) {
            ...
            if (f) {
              var g = firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.EmailAuthProvider.credential(d, f);
        ...
        K.passwordSignUp = function (a, b, c, d, e, f) {
          ...
          var h = new Um(xi(W(a)), function () {
            Vm(a, h);
          }, e ? void 0 : g, c, d, J(W(a)), wi(W(a)), f);
          h.render(b);
          Y(a, h);
        };
        ...
        u($m.prototype, {
          ...
          Db: Zm,
          U: function U(a) {
            ad(Zm.call(this), C("Resend code in " + ((9 < a ? "0:" : "0:0") + a)).toString());
          },
          ua: function ua() {
            Kj(this.Db());
          },
        ...
        var cn = !z && !(y("Safari") && !(Yb() || y("Coast") || y("Opera") || y("Edge") || y("Firefox") || y("FxiOS") || y("Silk") || y("Android")));
        ...
        function en(a, b, c) {
          ...
          O(this, a, function (e) {
            if (e = (e = bd(e.target, "firebaseui-id-list-box-dialog-button")) && dn(e, "listboxid")) jk.call(d), b(e);
          });
        }
        ...
        function mn(a, b, c) {
          var d = Qh(a);
          d && (c && (c = Va(Ti(gn.call(this)) || ""), b = Ph(b, c), b.length && b[0].b != d.b && (c = "+" + d.b + c.substr(b[0].b.length + 1), Ui(gn.call(this), c))), b = Qh(this.Ba), this.Ba = a, a = M(this, "firebaseui-id-country-selector-flag"), b && Si(a, on(b)), Ri(a, on(d)), ad(M(this, "firebaseui-id-country-selector-code"), "\u200E+" + d.b));
        }
          ...
          ea: function ea(a, b, c) {
            ...
            Gj(this, e, function () {
              ...
              var n = Va(Ti(e) || ""),
                  ...
                  H = Ph(h, n);
              n = ln("1-US-0", k);
              H.length && H[0].b != r.b && (r = H[0], mn.call(d, "1" == r.b && n ? "1-US-0" : r.c, h));
            });
            c && Hj(this, e, function () {
              c();
            });
          },
          U: function U(a) {
        ...
        K.phoneSignInStart = function (a, b, c, d) {
          ...
          var k = new qn(function (r) {
            rn(a, k, n, !(!r || !r.keyCode));
          }, Mi, f ? null : function () {
            n.clear();
            k.o();
            S(a, b);
          ...
          var n = new firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.RecaptchaVerifier(Mi ? k.ba() : k.i(), e, bn(a).app);
          V(a, k.I(t(n.render, n), [], function (r) {
            Oi = r;
          }, function (r) {
        ...
        K.providerSignIn = function (a, b, c, d) {
          var e = new tn(function (f) {
            f == firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.EmailAuthProvider.PROVIDER_ID ? (e.o(), Vl(a, b, d)) : f == firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.PhoneAuthProvider.PROVIDER_ID ? (e.o(), L("phoneSignInStart", a, b)) : "anonymous" == f ? Ql(a, e) : Nl(a, e, f, d);
            Z(a);
            a.l.cancel();
          }, ji(W(a)), J(W(a)), wi(W(a)));
          e.render(b);
        ...
        function xn(a, b) {
          ...
          this.Y = !1;
          An(this.a);
          this.h = firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].initializeApp({
            apiKey: a.app.options.apiKey,
            authDomain: a.app.options.authDomain
          }, a.app.name + "-firebaseui-temp").auth();
          An(this.h);
          this.h.setPersistence && this.h.setPersistence(firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.Auth.Persistence.SESSION);
          this.oa = b;
          this.ca = new bi();
        ...
        function Ol(a) {
          ...
          a.i || (a.i = Bn(a, function (b) {
            return b && !zh(X(a)) ? G(bn(a).getRedirectResult().then(function (c) {
              return c;
            }, function (c) {
              if (c && "auth/email-already-in-use" == c.code && c.email && c.credential) throw c;
              return Cn(a, c);
            })) : G(U(a).getRedirectResult().then(function (c) {
              return di(W(a)) && !c.user && a.j && !a.j.isAnonymous ? bn(a).getRedirectResult() : c;
            }));
          }));
          return a.i;
        }
        ...
        function Fn(a, b, c, d) {
          ...
          a.C ? a.C.then(function () {
            "complete" == f.readyState ? Gn(a, b) : me(window, "load", function () {
              Gn(a, b);
            });
          }) : "complete" == f.readyState ? Gn(a, b) : me(window, "load", function () {
            Gn(a, b);
        ...
        function Gn(a, b) {
          ...
          if (jh(new kh()) && jh(new lh())) {
            ...
            a: {
              ...
              for (f in Ki) {
                if (Ki[f].toLowerCase() == d.toLowerCase()) {
                  var f = Ki[f];
                  break a;
                }
              }
            ...
            switch (f) {
              ...
              case "revertSecondFactorAddition":
                L("revertSecondFactorAddition", a, b, Zl());
                break;
          ...
          } else b = sf(b, "Could not find the FirebaseUI widget element on the page."), f = new Fl(C("The browser you are using does not support Web Storage. Please try again in a different browser.").toString()), f.render(b), Y(a, f);
        ...
        function Kn(a) {
          Z(a);
          var b;
          (b = a.Z) || (a = W(a), a = ri(a, firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.GoogleAuthProvider.PROVIDER_ID), b = !(!a || "select_account" !== a.prompt));
          return b;
        }
        ...
        l.reset = function () {
          ...
          this.L = null;
          this.h && (this.C = im(this).then(function () {
            a.C = null;
          }, function () {
            a.C = null;
          }));
        ...
        l.Ub = function () {
          ...
          W(this).a.get("popupMode") ? (a = (window.screen.availHeight - 600) / 2, b = (window.screen.availWidth - 500) / 2, c = c || "about:blank", a = {
            ...
            statusbar: !0,
            toolbar: !1
          }, a.target = a.target || c.target || "google_popup", a.width = a.width || 690, a.height = a.height || 500, (a = pf(c, a)) && a.focus()) : Oc(window.location, c);
        };
        ...
        function un(a) {
          ...
          try {
            Qf(a.l, li(W(a)), Kn(a)).then(function (b) {
              return a.g ? Rl(a, a.g, b) : !1;
            });
          } catch (b) {}
        }
        ...
        function Hm(a, b, c, d, e) {
          Z(a);
          var f = e || null,
              g = firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.EmailAuthProvider.credentialWithLink(c, d);
          ...
          return U(this).signInWithEmailAndPassword(a, b).then(function (d) {
            return Bn(c, function (e) {
              return e ? im(c).then(function () {
                return Cn(c, {
                  code: "auth/email-already-in-use"
                }, firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.EmailAuthProvider.credential(a, b));
              }) : d;
            });
          });
        };
        ...
        l.Wb = function (a, b) {
          ...
          return Bn(this, function (d) {
            if (d) {
              var e = firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth.EmailAuthProvider.credential(a, b);
          ...
          return Bn(this, function (d) {
            return d ? d.linkWithPhoneNumber(a, b).then(function (e) {
              return new Sf(e, function (f) {
                if ("auth/credential-already-in-use" == f.code) return Cn(c, f);
                throw f;
              });
        ...
        function Kl(a, b) {
          Z(a);
          return Bn(a, function (c) {
            if (a.j && !a.j.isAnonymous && di(W(a)) && !U(a).currentUser) return im(a).then(function () {
              "password" == b.credential.providerId && (b.credential = null);
              return b;
            });
            if (c) return im(a).then(function () {
        ...
        function Ln(a, b, c, d) {
          P.call(this, el, void 0, d, "providerMatchByEmail", {
            F: b,
            D: c
          });
          this.i = a;
        ...
        function On(a) {
          P.call(this, zk, void 0, a, "spinner");
        }
        ...
        function Wn(a, b) {
          a = a.a.get("tenants");
          if (!a || !a.hasOwnProperty(b) && !a.hasOwnProperty(Xn)) throw Error("Invalid tenant configuration!");
        }
        ...
        l.Nb = function (a, b) {
          ...
          try {
            this.i = firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].app(c).auth();
          } catch (e) {
            var d = this.a[a].a.get("authDomain");
            if (!d) throw Error("Invalid project configuration: authDomain is required!");
            a = firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].initializeApp({
              apiKey: a,
              authDomain: d
            }, c);
            a.auth().tenantId = b;
        ...
        l.Xb = function (a, b) {
          ...
          return new F(function (d, e) {
            ...
            co(c);
            e = {
              signInSuccessWithAuthResult: function signInSuccessWithAuthResult(H) {
                d(H);
                return !1;
              }
            };
            ...
            e.uiChanged = function (H, Ba) {
              null === H && "callback" === Ba ? ((H = Wc("firebaseui-id-page-callback", c.s)) && Kj(H), c.h = new On(), c.h.render(c.s)) : n || null === H && "spinner" === Ba || "blank" === Ba || (c.h && (c.h.o(), c.h = null), n = !0, k && k(a.tenantId));
            };
        ...
        v("firebaseui.auth.FirebaseUiHandler.prototype.hideProgressBar", bo.prototype.mb);
  ...
  /***/
  function node_modulesMaterialDesignLiteSrcButtonButtonJs(module, exports) {
    /**
     * @license
  ...
  /***/
  function node_modulesMaterialDesignLiteSrcMdlComponentHandlerJs(module, exports) {
    /**
     * @license
     * Copyright 2015 Google Inc. All Rights Reserved.
     *
  ...
  /***/
  function node_modulesMaterialDesignLiteSrcProgressProgressJs(module, exports) {
    /**
     * @license
     * Copyright 2015 Google Inc. All Rights Reserved.
     *
  ...
  /***/
  function node_modulesMaterialDesignLiteSrcSpinnerSpinnerJs(module, exports) {
    /**
     * @license
     * Copyright 2015 Google Inc. All Rights Reserved.
     *
  ...
  /***/
  function node_modulesMaterialDesignLiteSrcTextfieldTextfieldJs(module, exports) {
    /**
     * @license
     * Copyright 2015 Google Inc. All Rights Reserved.
     *
  ...
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/phone-login/phone-login.page.html":
  /*!***********************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/pages/phone-login/phone-login.page.html ***!
    \***********************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesPhoneLoginPhoneLoginPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/pages/phone-login/phone-login-routing.module.ts":
  /*!*****************************************************************!*\
    !*** ./src/app/pages/phone-login/phone-login-routing.module.ts ***!
    \*****************************************************************/

  /*! exports provided: PhoneLoginPageRoutingModule */

  /***/
  function srcAppPagesPhoneLoginPhoneLoginRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PhoneLoginPageRoutingModule", function () {
      return PhoneLoginPageRoutingModule;
    });
    /* harmony import */
    ...
    var _phone_login_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./phone-login.page */
    "./src/app/pages/phone-login/phone-login.page.ts");

    var routes = [{
      path: '',
      component: _phone_login_page__WEBPACK_IMPORTED_MODULE_3__["PhoneLoginPage"]
    }];

    var PhoneLoginPageRoutingModule = function PhoneLoginPageRoutingModule() {
      _classCallCheck(this, PhoneLoginPageRoutingModule);
    };

    PhoneLoginPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  "./src/app/pages/phone-login/phone-login.module.ts":
  /*!*********************************************************!*\
    !*** ./src/app/pages/phone-login/phone-login.module.ts ***!
    \*********************************************************/

  /*! exports provided: PhoneLoginPageModule */

  /***/
  function srcAppPagesPhoneLoginPhoneLoginModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PhoneLoginPageModule", function () {
      return PhoneLoginPageModule;
    });
    /* harmony import */
    ...
    var _phone_login_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./phone-login-routing.module */
    "./src/app/pages/phone-login/phone-login-routing.module.ts");
    /* harmony import */


    var _phone_login_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./phone-login.page */
    "./src/app/pages/phone-login/phone-login.page.ts");
    /* harmony import */
    ...
    var firebaseUiAuthConfig = {
      signInFlow: 'popup',
      signInOptions: [{
        provider: firebaseui_angular__WEBPACK_IMPORTED_MODULE_7__["firebase"].auth.PhoneAuthProvider.PROVIDER_ID,
        defaultCountry: 'IN',
        defaultNationalNumber: '1234567890',
        loginHint: '+911234567890',
        whitelistedCountries: ['IN', '+91'],
        buttonColor: 'crimson'
      }, firebaseui_angular__WEBPACK_IMPORTED_MODULE_7__["firebaseui"].auth.AnonymousAuthProvider.PROVIDER_ID],
      privacyPolicyUrl: '<your-privacyPolicyUrl-link>',
      credentialHelper: firebaseui_angular__WEBPACK_IMPORTED_MODULE_7__["firebaseui"].auth.CredentialHelper.GOOGLE_YOLO
    };

    var PhoneLoginPageModule = function PhoneLoginPageModule() {
      _classCallCheck(this, PhoneLoginPageModule);
    };

    PhoneLoginPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _phone_login_routing_module__WEBPACK_IMPORTED_MODULE_5__["PhoneLoginPageRoutingModule"], firebaseui_angular__WEBPACK_IMPORTED_MODULE_7__["FirebaseUIModule"].forRoot(firebaseUiAuthConfig), _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"]],
      declarations: [_phone_login_page__WEBPACK_IMPORTED_MODULE_6__["PhoneLoginPage"]]
    })], PhoneLoginPageModule);
    /***/
  },

  /***/
  "./src/app/pages/phone-login/phone-login.page.scss":
  /*!*********************************************************!*\
    !*** ./src/app/pages/phone-login/phone-login.page.scss ***!
    \*********************************************************/
  ...
  /***/
  function srcAppPagesPhoneLoginPhoneLoginPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "ion-header {\n  text-align: center;\n}\n\nion-toolbar {\n  color: white;\n}\n\nion-card-header {\n  background-color: #b94545;\n  color: white;\n}\n\n.logOut {\n  text-align: center;\n}\n\n.spin {\n  position: fixed;\n  left: 50%;\n  top: 50%;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  /*! exports provided: PhoneLoginPage */

  /***/
  function srcAppPagesPhoneLoginPhoneLoginPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PhoneLoginPage", function () {
    ...
    var PhoneLoginPage = /*#__PURE__*/function () {
      function PhoneLoginPage(angularFireAuth, accountProvider, alertController, formBuilder, toastController, appService) {
      ...
      _createClass(PhoneLoginPage, [{
        ...
        key: "successCallback",
        value: function successCallback(signInSuccessData) {
          var _this3 = this;

          console.log("successCallback called");
          this.isSuccess = true;
          var phoneNumber = signInSuccessData.authResult.user.phoneNumber;
          console.log("Phone number is:" + phoneNumber); // check for new user in customer collection.
          // if (newuser)
          ...
          this.customerCreationObservableSubsc = this.accountProvider.getCustomer(phoneNumber).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["take"])(1)).pipe((Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () {
            return _this3.appService.isLoading(false);
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["shareReplay"])())).subscribe(function (result) {
            if (result == null) // no user data found for given phonenumber.
              {
                ...
                _this3.accountProvider.createCustomer(customer).then(function (result) {
                  // user has been created successfully
                  if (result.customerId != undefined) {
                    console.log("User Id is :" + result.customerId);
                    _this3.tempObj = result;

                    _this3.accountInfoForm.setValue({
                      name: result.name,
        ...
        key: "errorCallback",
        value: function errorCallback(errorData) {
        ...
        key: "uiShownCallback",
        value: function uiShownCallback() {
          this.isLoggedIn = false;
        }
      }, {
        key: "editDetails",
        ...
        value: function getLoggedInUser() {
          ...
          this.userLoggedSubscription = this.angularFireAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () {
            return _this4.appService.isLoading(false);
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["shareReplay"])()).subscribe(function (user) {
            if (user) {
              _this4.isLoggedIn = true;
              _this4.formSettingSubscription = _this4.accountProvider.getCustomer(user.phoneNumber).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])()).subscribe(function (customer) {
                if (customer != null) {
                  _this4.tempObj = customer;
                  console.log(customer);

                  _this4.accountInfoForm.setValue({
                    ...
                    alternativeContact: customer === null || customer === void 0 ? void 0 : customer.alternativeContact,
                    landmark: customer === null || customer === void 0 ? void 0 : customer.landmark,
                    postCode: customer === null || customer === void 0 ? void 0 : customer.postCode,
            ...
            return regeneratorRuntime.wrap(function _callee5$(_context5) {
              while (1) {
                switch (_context5.prev = _context5.next) {
                  case 0:
                    _context5.next = 2;
                    return this.presentLogOutConfirm();
        ...
        value: function logOut() {
          ...
          this.angularFireAuth.signOut().then(function () {
            ...
            _this5.appService.isLoading(false); // hide loader


            _this5.getLoggedInUser();
          })["catch"](function (err) {
        ...
        key: "presentLogOutConfirm",
        value: function presentLogOutConfirm() {
        ...
        value: function submit(formValue) {
          ...
          this.accountProvider.updateCustomer(updatedCustomerObj).then(function (result) {
                ...
                while (1) {
                  switch (_context9.prev = _context9.next) {
                    case 0:
                      ...
                      _context9.next = 3;
                      return this.presentCustomerDataUpdateToast();
            ...
            _this7.appService.isLoading(false); // hide loader


            _this7.presentErrorAlert();
          }); // call the api to update the document.
        }
      }, {
        key: "presentCustomerDataUpdateToast",
        value: function presentCustomerDataUpdateToast() {
    ...
    PhoneLoginPage.ctorParameters = function () {
      return [{
    ...
    PhoneLoginPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-phone-login',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./phone-login.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/phone-login/phone-login.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./phone-login.page.scss */
      "./src/app/pages/phone-login/phone-login.page.scss"))["default"]]
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_fire_auth__WEBPACK_IMPORTED_MODULE_2__["AngularFireAuth"], _providers_account_provider__WEBPACK_IMPORTED_MODULE_6__["AccountProvider"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["AlertController"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ToastController"], _providers_app_service__WEBPACK_IMPORTED_MODULE_7__["AppService"]])], PhoneLoginPage);
    /***/
  }
}]);
//# sourceMappingURL=default~pages-phone-login-phone-login-module~phone-login-phone-login-module-es5.js.map