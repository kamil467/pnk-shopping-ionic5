...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["product-list-product-list-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesProductListProductListHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppPagesProductListProductListRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _product_list__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./product-list */
  ...
  function srcAppPagesProductListProductListModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _product_list__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./product-list */
    "./src/app/pages/product-list/product-list.ts");
    /* harmony import */


    var _product_list_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
  ...
  /***/
  function srcAppPagesProductListProductListScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesProductListProductListTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _providers_product_list_provider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../../providers/product-list.provider */
    ...
    var ProductListPage = /*#__PURE__*/function () {
      function ProductListPage(productListProvider, basketProvider, loader, alert, route) {
      ...
      _createClass(ProductListPage, [{
        ...
        value: function ngOnInit() {
          ...
          var productCategoryCode = this.route.snapshot.paramMap.get('productCategoryCode'); // get the productcategoryCode.

          this.allProductsAbservable = this.productListProvider.getActiveProductList(productCategoryCode, storeCode); // observable will be called on template  

          this.getBasketFromMemory();
        } // get latest basket from in-memory.

      }, {
        key: "getBasketFromMemory",
        value: function getBasketFromMemory() {
        ...
        value: function addToBasket(product) {
          console.log("add to basket clicked" + product.name); // build orderItem.

          this.basketProvider.addItemToBasket(product);
          this.getBasketFromMemory(); // refresh the basket everytim.// local call - no expensive service call.
        }
      }]);
    ...
    ProductListPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      /*! raw-loader!./product-list.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/product-list/product-list.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./product-list.scss */
      "./src/app/pages/product-list/product-list.scss"))["default"]]
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_providers_product_list_provider__WEBPACK_IMPORTED_MODULE_6__["ProductListProvider"], _providers_basket_provider__WEBPACK_IMPORTED_MODULE_5__["BasketProvider"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["LoadingController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["AlertController"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]])], ProductListPage);
    /***/
  },
  ...
  /***/
  function srcAppProvidersProductListProviderTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProductListProvider", function () {
    ...
    var ProductListProvider = /*#__PURE__*/function () {
      /* Data Initialization */
      function ProductListProvider(http, angularFireCloudStore) {
        _classCallCheck(this, ProductListProvider);

        this.http = http;
        this.angularFireCloudStore = angularFireCloudStore;
      }

      _createClass(ProductListProvider, [{
        key: "getProductsByCategory",
        value: function getProductsByCategory(categroyCode) {
          var _this = this;

          return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].productListAPI).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(3), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            return _this.handleError(err);
          }));
        }
      }, {
        key: "getActiveProductMappingListByCategoryCode",
        value: function getActiveProductMappingListByCategoryCode(categorCode, shopCode) {
          var _this2 = this;

          var productsMapResult = this.angularFireCloudStore.collection(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].SHOP_LIST_COLLECTION).doc(shopCode).collection(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].PRODUCT_CATEGORY_MAPPING, function (ref) {
            return ref.where("categoryId", "==", categorCode);
          }).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            return _this2.handleError(err, "getActiveProductMappingListByCategoryCode");
          }));
          return productsMapResult;
        }
      }, {
        key: "getActiveProduct",
        value: function getActiveProduct(productId, shopCode) {
          var _this3 = this;

          var productRef = this.angularFireCloudStore.collection(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].SHOP_LIST_COLLECTION).doc(shopCode).collection(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].PRODUCT_LIST, function (ref) {
            return ref.where("status", "==", "a");
          }).doc(productId).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (finalData) {
            console.log("data is :" + finalData.name);
            return Object.assign(Object.assign({}, finalData), {
              id: productId
            }); // load the id.
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            return _this3.handleError(err, "getActiveProduct");
          }));
          return productRef;
        }
      }, {
        key: "getActiveProductList",
        value: function getActiveProductList(categoryCode, shopCode) {
          var _this4 = this;

          var productList = this.getActiveProductMappingListByCategoryCode(categoryCode, shopCode).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["mergeMap"])(function (productMapping) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])(productMapping).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["mergeMap"])(function (pMap) {
              return _this4.getActiveProduct(pMap.productId, shopCode).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (product) {
                return Object.assign({}, product);
              }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["first"])());
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["toArray"])());
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            return _this4.handleError(err, "getActiveProductList");
          }));
          return productList;
        }
      }, {
    ...
    ProductListProvider.ctorParameters = function () {
      return [{
    ...
    ProductListProvider = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
      providedIn: "root"
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_6__["AngularFirestore"]])], ProductListProvider);
    /***/
  }
}]);
